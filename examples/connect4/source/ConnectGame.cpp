...
void ConnectGame::init()
{
    ...
    main.setFrameLayout({0.5, 0.5, 1, (float)display.w/display.h}, display.w*2, display.h*2);
    ...
    frameRenderer.context.applyResolution(display.w*2, display.h*2);
...
{
    //SDL_SetRenderDrawBlendMode(gameRenderer.renderer, SDL_BLENDMODE_NONE);
    //SDL_SetRenderDrawColor(gameRenderer.renderer, frameRenderer.backgroundColor.r, frameRenderer.backgroundColor.b, frameRenderer.backgroundColor.g, frameRenderer.backgroundColor.a); // Color #deebd4
    //SDL_RenderFillRect(gameRenderer.renderer,&main.absoluteLayout);

    gameRenderer.render();
    frameRenderer.render();
    //SDL_RenderCopy(gameRenderer.renderer, gameRenderer.target, nullptr, &contextHack.absoluteLayout);
